...
{
    public class Request_CommitteeEditLoan_Approve
    {

        TakafulEntities tpDB = new TakafulEntities();

        public DataObjects.Internal.Request_CommitteeEditLoan_Approve.MainObject GetInitialData(long empID, int year, int serial)
        {

            var defaultDataObj = new DataObjects.Internal.Request_CommitteeEditLoan_Approve.MainObject();
        ...
        public DataObjects.Internal.Request_CommitteeEditLoan_Approve.NavigationObject Navigate(long empID, int year, int serial, int direction)
        {

            var defaultDataObj = new DataObjects.Internal.Request_CommitteeEditLoan_Approve.NavigationObject();
