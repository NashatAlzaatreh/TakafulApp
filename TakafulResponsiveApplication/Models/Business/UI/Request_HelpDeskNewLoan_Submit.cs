...
{
    public class Request_HelpDeskNewLoan_Submit
    {

        TakafulEntities tpDB = new TakafulEntities();

        public DataObjects.Internal.Request_NewLoan_Submit.MainObject GetInitialData(long empID)
        {
            ...
            if (employee != null && employee.SubscriptionData != null)
            {
        ...
        public string Submit(long empID, int loanAmount, int installmentAmount, string notes)
        {
