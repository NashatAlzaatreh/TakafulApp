...
namespace TakafulResponsiveApplication.Models.Business.UI
{
    public class Request_CommitteeCancelSubscription_Approve
    {
        ...
        public DataObjects.Internal.Request_CommitteeCancelSubscription_Approve.MainObject GetInitialData(long empID, int year, int serial)
        {

            var defaultDataObj = new DataObjects.Internal.Request_CommitteeCancelSubscription_Approve.MainObject();
        ...
        public DataObjects.Internal.Request_CommitteeCancelSubscription_Approve.NavigationObject Navigate(long empID, int year, int serial, int direction)
        {

            var defaultDataObj = new DataObjects.Internal.Request_CommitteeCancelSubscription_Approve.NavigationObject();
