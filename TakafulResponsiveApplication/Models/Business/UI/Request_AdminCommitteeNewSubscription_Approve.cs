...
{
    public class Request_AdminCommitteeNewSubscription_Approve
    {

        TakafulEntities tpDB = new TakafulEntities();

        public DataObjects.Internal.Request_AdminCommitteeNewSubscription_Approve.MainObject GetInitialData(long empID, int year, int serial)
        {

            var defaultDataObj = new DataObjects.Internal.Request_AdminCommitteeNewSubscription_Approve.MainObject();
