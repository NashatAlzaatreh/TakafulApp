...
{
    public class Request_HelpDeskEditSubscription_Submit
    {

        TakafulEntities tpDB = new TakafulEntities();

        public DataObjects.Internal.Request_EditSubscription_Submit.MainObject GetInitialData(long empID)
        {
        ...
        public string EditSubscription(long empID, int amount, string notes)
        {
