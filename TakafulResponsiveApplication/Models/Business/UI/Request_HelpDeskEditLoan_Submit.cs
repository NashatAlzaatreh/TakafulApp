...
{
    public class Request_HelpDeskEditLoan_Submit
    {

        TakafulEntities tpDB = new TakafulEntities();

        public DataObjects.Internal.Request_EditLoan_Submit.MainObject GetInitialData(long empID)
        {
        ...
        public string Submit(long empID, int amount, string notes)
        {
            ...
            //Check if eligible to edit installment
