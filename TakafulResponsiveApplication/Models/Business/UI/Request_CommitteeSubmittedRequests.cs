...
namespace TakafulResponsiveApplication.Models.Business.UI
{
    public class Request_CommitteeSubmittedRequests
    {
        ...
        public DataObjects.Internal.Request_CommitteeSubmittedRequests.MainObject GetInitialData()
        {

            var defaultDataObj = new DataObjects.Internal.Request_CommitteeSubmittedRequests.MainObject();
            ...
            {
                var temp = new DataObjects.Internal.Request_CommitteeSubmittedRequests.Request();
