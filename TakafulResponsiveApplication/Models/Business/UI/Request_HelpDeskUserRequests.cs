...
{
    public class Request_HelpDeskUserRequests
    {

        TakafulEntities tpDB = new TakafulEntities();

        public List<DataObjects.Internal.Request_UserRequests.MainObject> GetInitialData(long empID)
        {
        ...
        public string WithdrawSubmittedRequest(long empID, int year, int serial)
        {
            var bus = new Common.Common.Business();

            return bus.WithdrawUserRequest(empID, year, serial, "Rejected on behalf of the user.");
        }
