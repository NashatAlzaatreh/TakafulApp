...
{
    public class Request_HelpDeskCancelSubscription_Submit
    {

        TakafulEntities tpDB = new TakafulEntities();

        public DataObjects.Internal.Request_CancelSubscription_Submit.MainObject GetInitialData(long empID)
        {
